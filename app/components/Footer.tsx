...
export default function Footer() {
    return (
        <div id="footer" className="bg-[#272727] relative text-sm gap-10 flex flex-col pt-20 pb-5 w-full">
            ...
            <div className="w-full text-white px-3 lg:px-16 2xl:px-96 z-10 flex flex-col md:flex-row gap-3 justify-between">
                ...
                <p className="hover:text-blue-400 cursor-pointer">Terms and Conditions</p>
            </div>
            <Link className="text-blue-400 px-3 lg:px-16 2xl:px-96 " href={'/adminAuth'} dir="rtl">Management</Link>
        </div>
    )
}