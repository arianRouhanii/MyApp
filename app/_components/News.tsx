                        ...
                        <SwiperSlide>
                            <div className="w-full flex flex-row gap-10">
                                <div className="z-10 group">
                                    <div className="bg-black overflow-hidden"><Image className="group-hover:opacity-60 group-hover:scale-110 " alt="" width={1000} height={1000} src={"/Picture.webp"}></Image></div>
                                    <div className="relative bottom-5 group-hover:bottom-10 flex flex-row justify-center pr-5">
                                        <div className="inline-block bg-blue-500 w-[90%] text-end p-4 justify-center">
