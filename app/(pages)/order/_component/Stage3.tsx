        ...
        <form className="xl:h-[100vh] bg-[#EAEAEA] text-xl p-16" dir="rtl">
            <div className="gap-10 h-full w-full justify-between flex flex-col">
                <div className="w-full flex flex-col gap-5">
                    ...
                    <div className="w-full flex flex-col p-10 gap-10">
                        ...
                        <div className="flex flex-col">
                            ...
                            <input type="tel" required value={phoneNumber} onChange={handleInputChange} onInput={handleInputChange} maxLength={11} className="border-blue-400 text-center w-[300px] border bg-gray-100 outline-0 rounded-sm p-2" id="phone" />
                        </div>
                    </div>
                </div>
                <div className="flex flex-col gap-5">
                    <div>
                    <div>
                        <button type="submit" onClick={() => setPageState(4)} className=" rounded-full relative flex flex-row justify-center bg-blue-400 hover:bg-blue-500 text-white p-2 cursor-pointer w-[200px]" >
